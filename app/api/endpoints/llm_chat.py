...
from app.schemas.llm_chat import LlmChatCompletionRequest, LlmChatCompletionResponse
...
async def llm_chat_completions_endpoint(request_id: str, request: LlmChatCompletionRequest):
